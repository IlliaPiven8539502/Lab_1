...
У ході лабороторної роботи був створений проєкт зосереджений на **життєвому циклі повідомлення** та механізмі оновлення статусів. Ключове архітектурне рішення — використання **явних ACK від клієнта** замість серверної інференції, що забезпечує точне та надійне відстеження статусів ціною додаткової складності на стороні клієнта.
